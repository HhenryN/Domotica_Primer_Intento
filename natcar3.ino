...
#define MOTORRIGHT_DIR_A  9           // pin 1 de direccion del Motor Derecho
#define MOTORRIGHT_DIR_B  10           // pin 2 de direccion del Motor Derecho
#define MOTORRIGHT_PWM    11           // pin PWM del Motor Derecho
...
#define LEDPIN     1                // número del pin de test
#define BUTTONPIN  12                 // boton externo
